#parts of the code here was used later to make the contfrac module. I didnt bother to clean it up later to make the code here more compact by invoking the module.
